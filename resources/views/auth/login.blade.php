...
<section class="flex bg-gray-50 dark:bg-gray-900">
    <div class="w-[1000px] flex justify-center items-center">
        <img class="w-[700px]" src="{{asset('/img/anim.png')}}" alt="">
    </div>
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img class="w-30 mr-2" src="/img/unusida logo.png" alt="#">
        </a>
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Belum punya akun?yuk <a href="{{ route('register') }}"
                            class="font-medium text-green-600 hover:underline dark:text-green-500">Daftar</a>
                    </p>
                </form>
            </div>
        </div>
