...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-green-50">
    ...
    <div class="flex items-end gap-5  pb-4">
        ...
        <a type="button" href="/register" class="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
