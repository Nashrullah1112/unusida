...
<section class="bg-gray-50 dark:bg-gray-900 flex">
    <div class="w-3/5 flex justify-center items-center">
        <img class="w-[700px]" src="{{asset('/img/signup.png')}}" alt="">
    </div>
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <input type="TEXT" name="name" id="nama"
                                ...
                                placeholder="name@company.com" value="{{ old('name') }}" required autocomplete="name"
                                autofocus>
                            ...
                            <div>
                                <fieldset>
                                    <div class="flex items-center mb-4">
                                        <input id="country-option-1" type="radio" name="countries" value="mahasiswa"
                                    ...
                                    <div class="flex items-center mb-4">
                                        <input id="country-option-2" type="radio" name="countries" value="dosen"
                                            class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
