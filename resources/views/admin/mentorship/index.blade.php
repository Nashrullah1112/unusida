    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 results">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    {{ $mahasiswa->dosen == null ? 'belum ada pembimbing' : $mahasiswa->dosen->user->name }}
                </td>
                <td class="px-6 py-4">
                    <a href="{{ route('admin.mentorship.show', ['id' => $mahasiswa->id]) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium
                                    rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
