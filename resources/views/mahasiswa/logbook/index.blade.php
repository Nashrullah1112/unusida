...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-green-50">
    <div class="flex items-end justify-between pb-4">
        ...
        <div class="ml-4">
            <a href="{{ route('mahasiswa.logbook.create') }}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                Add New Logbook
            </a>
        </div>
    </div>
